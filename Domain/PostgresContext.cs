...
using Domain.Entities.Supabase;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bucket>(entity =>
        {
            ...
            entity.HasOne(d => d.OwnerNavigation).WithMany(p => p.Buckets)
        ...
        modelBuilder.Entity<Cliente>(entity =>
        {
            ...
            entity.ToTable("Cliente", tb => tb.HasComment("Guarda los clientes en el sistema"));
        ...
        modelBuilder.Entity<Habitacion>(entity =>
        {
            ...
            entity.ToTable("Habitacion", tb => tb.HasComment("Guarda las habitaciones del sistema"));
            ...
            entity.Property(e => e.Usos).HasColumnName("usos");

            entity.HasOne(d => d.IdTipoNavigation).WithMany(p => p.Habitacions)
                .HasForeignKey(d => d.IdTipo)
                .HasConstraintName("Habitacion_idTipo_fkey");
        });
        ...
        modelBuilder.Entity<Menu>(entity =>
        {
            ...
            entity.ToTable("Menu", tb => tb.HasComment("Guarda los Menus del sistema"));
        ...
        {
            entity.HasKey(e => e.Id).HasName("MenuRol_pkey");

            entity.ToTable("MenuRol", tb => tb.HasComment("Define que usuario tiene permisos a los menus"));
        ...
        modelBuilder.Entity<Entities.Supabase.Object>(entity =>
        {
            ...
            entity.HasOne(d => d.OwnerNavigation).WithMany(p => p.Objects)
                .HasForeignKey(d => d.Owner)
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.ToTable("Reserva", tb => tb.HasComment("Guarda las reservas del sistema"));

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Acompañantes).HasColumnName("acompañantes");
            entity.Property(e => e.Cedula)
                .HasColumnType("character varying")
                .HasColumnName("cedula");
            entity.Property(e => e.DiaHospedaje).HasColumnName("diaHospedaje");
            ...
            entity.HasOne(d => d.CedulaNavigation).WithMany(p => p.Reservas)
                ...
                .HasConstraintName("Reserva_cedula_fkey");
        ...
        modelBuilder.Entity<Rol>(entity =>
        {
            ...
            entity.ToTable("Rol", tb => tb.HasComment("Guarda los roles del sistema"));
        ...
        modelBuilder.Entity<TipoHabitacion>(entity =>
        {
            ...
            entity.ToTable("TipoHabitacion", tb => tb.HasComment("Guarda los tipos de habitaciones del sistema"));
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.ToTable("Usuario", tb => tb.HasComment("Guarda los usuarios del sistema"));
